  ...
  return (
    <div className="space-y-6">
      ...
      {myClass?.schedule?.length > 0 && (
        <div
          className="card p-5 animate-fade-in-up delay-225 cursor-pointer hover:shadow-md transition-all duration-200 group"
          onClick={() => navigate('/student/attendance')}
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
            {myClass.schedule.map((s, i) => (
              <div key={i} className="p-3.5 rounded-xl border-2 border-brand-green-100 dark:border-brand-green-900/40 bg-brand-green-50/50 dark:bg-brand-green-900/10 hover:border-brand-green-400 transition-colors">
